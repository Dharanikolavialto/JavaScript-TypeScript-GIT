function findDuplicate(paths: string[]): string[][] {
    const contMap: Map<string, string[]> = new Map();
    const ans: string[][] = [];
...
const paths1: string[] = ["root/a 1.txt(abcd) 2.txt(efgh)", "root/c 3.txt(abcd)", "root/c/d 4.txt(efgh)", "root 4.txt(efgh)"];
console.log(findDuplicate(paths1));

const paths2: string[] = ["root/a 1.txt(abcd) 2.txt(efgh)", "root/c 3.txt(abcd)", "root/c/d 4.txt(efgh)"];
